...
public class Tree {
	...
	private boolean checkIfHeap(Node currentNode){
		if(currentNode.getRightChild() != null){
			if(currentNode.getRightChild().getContent() > currentNode.getContent())
				return false;
			else
				return checkIfHeap(currentNode.getRightChild());
		}
		if(currentNode.getLeftChild() != null){
			if(currentNode.getLeftChild().getContent() > currentNode.getContent())
				return false;
			else
